...
@Component({
  selector: 'app-pagezime-konfeta',
  templateUrl: './pagezime-konfeta.component.html',
  styleUrls: ['./pagezime-konfeta.component.css']
})
export class PagezimeKonfetaComponent implements OnInit {
  eventsList: any = [];
  dialogRef: any;
  toBeEdited: any;
  ...
  ngOnInit() {
    ...
    this.getAllPagezimeKonfeta();
  }

  getAllPagezimeKonfeta() {
    this.eventsService.getSpecificEvents('konfeta', 'pagezime').subscribe(data => {
