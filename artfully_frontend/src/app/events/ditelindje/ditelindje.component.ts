...
@Component({
  selector: 'app-ditelindje',
  templateUrl: './ditelindje.component.html',
  styleUrls: ['./ditelindje.component.css']
})
export class DitelindjeComponent {
  ...
  ngOnInit(){
    ...
    this.getAllDitelindje();
  }

  getAllDitelindje(){
    this.eventsService.getSpecificEvents('event', 'ditelindje').subscribe(data => {
